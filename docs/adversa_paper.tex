...
100/100 across 19 detected techniques; the Auditor confirmed 15
(including T1003.002 SAM credential dump, T1055 process injection,
...
signals without disk corroboration. All findings
...
\midrule
nfury (10.3.58.6) & 100 & 100 & 15 techniques (see \cref{tab:nfury}) & 4 techniques \\
\bottomrule
\end{tabular}
\end{table}
...
was investigated autonomously; the Forensic Auditor confirmed 15 of 19
triage detections on physical artifacts and refuted 4 memory-only
signals. The complete attack chain---httppump backdoor
(\texttt{svchost.exe} in \texttt{\$Recycle.Bin}, timestomped,
...
movement---was characterized in 969\,s at \$14 cost.
