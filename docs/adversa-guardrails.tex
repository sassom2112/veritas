...
\begin{tikzpicture}[
    ...
    \node (G1) [layer=red!8, draw=red!70!black, below=0.5cm of sep] {
        ...
        \footnotesize
        172 blocked patterns: \texttt{rm}, \texttt{dd}, \texttt{mkfs}, \texttt{shred},
        \texttt{truncate}, write-mode flags, pipe-to-shell patterns \\[1pt]
    ...
    \node (guarantee) [
        ...
        \footnotesize
        Every command execution is appended to \texttt{chain\_of\_custody.json} for audit.
    };
